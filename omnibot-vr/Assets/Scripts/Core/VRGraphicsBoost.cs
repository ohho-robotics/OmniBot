...
namespace OmniBot.VR.Core
{
    ...
    {
        [Header("Resolution")]
        [Tooltip("Multiplier on the OpenXR eye texture size. 1.0 = stock, 2.0 = ultra-sharp on Quest 3.")]
        [SerializeField, Range(0.75f, 2.5f)] private float eyeTextureResolutionScale = 2.0f;
